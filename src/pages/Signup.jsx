    ...
    <div className="animate-fade-in">
      <GlassCard className="p-8 shadow-glass-lg relative overflow-hidden">
        ...
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold font-poppins text-white mb-2">Create Account</h2>
          <p className="text-gray-400 text-sm">Join AlgoVerse to start your learning journey</p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-5">
          ...
          <label className="flex items-start gap-3 mt-4">
            <input type="checkbox" className="mt-1 bg-navy-900 border-white/20 rounded text-purple-500 focus:ring-purple-500/50" required />
